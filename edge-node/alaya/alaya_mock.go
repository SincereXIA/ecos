...
// Package alaya is a generated GoMock package.
package alaya
...
func (m *MockAlayaer) DeleteMeta(arg0 context.Context, arg1 *DeleteMetaRequest) (*common.Result, error) {
	m.ctrl.T.Helper()
...
func (m *MockAlayaer) GetObjectMeta(arg0 context.Context, arg1 *MetaRequest) (*object.ObjectMeta, error) {
	m.ctrl.T.Helper()
...
func (m *MockAlayaer) ListMeta(arg0 context.Context, arg1 *ListMetaRequest) (*ObjectMetaList, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListMeta", arg0, arg1)
	ret0, _ := ret[0].(*ObjectMetaList)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockAlayaer) SendRaftMessage(arg0 context.Context, arg1 *PGRaftMessage) (*PGRaftMessage, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SendRaftMessage", arg0, arg1)
	ret0, _ := ret[0].(*PGRaftMessage)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
