...
type Pipeline struct {
	...
	ClusterTerm          uint64            `protobuf:"varint,4,opt,name=cluster_term,json=clusterTerm,proto3" json:"cluster_term,omitempty"`
...
func (m *Pipeline) GetClusterTerm() uint64 {
	if m != nil {
		return m.ClusterTerm
	}
	return 0
}
...
var fileDescriptor_7ac67a7adf3df9c7 = []byte{
	...
	0xed, 0x60, 0xe4, 0xe2, 0x08, 0x80, 0xaa, 0x15, 0x12, 0xe6, 0x62, 0x2d, 0x48, 0x8f, 0xcf, 0x4c,
	...
	0x25, 0x87, 0x54, 0x16, 0xa4, 0x06, 0x71, 0x14, 0x43, 0x59, 0x42, 0x8a, 0x5c, 0x3c, 0xc9, 0x39,
	0xa5, 0xc5, 0x25, 0xa9, 0x45, 0xf1, 0x25, 0xa9, 0x45, 0xb9, 0x12, 0x2c, 0x60, 0xfb, 0xb8, 0xa1,
	0x62, 0x21, 0xa9, 0x45, 0xb9, 0x4a, 0x0a, 0x5c, 0x1c, 0x30, 0x8d, 0x42, 0x1c, 0x5c, 0x2c, 0x41,
	0x8e, 0x6e, 0x21, 0x02, 0x0c, 0x42, 0x5c, 0x5c, 0x6c, 0xc1, 0x21, 0x41, 0xae, 0x8e, 0xbe, 0x02,
	0x8c, 0x4e, 0x9a, 0x27, 0x1e, 0xc9, 0x31, 0x5e, 0x78, 0x24, 0xc7, 0xf8, 0xe0, 0x91, 0x1c, 0xe3,
	0x8c, 0xc7, 0x72, 0x0c, 0x51, 0xe2, 0xa9, 0xc9, 0xf9, 0xc5, 0xfa, 0xa9, 0x29, 0xe9, 0xa9, 0xba,
	0x79, 0xf9, 0x29, 0xa9, 0xfa, 0xb0, 0x40, 0x48, 0x62, 0x03, 0x7b, 0xd6, 0x18, 0x10, 0x00, 0x00,
	0xff, 0xff, 0x4b, 0x32, 0xa2, 0xa8, 0x17, 0x01, 0x00, 0x00,
}
...
func (m *Pipeline) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ClusterTerm != 0 {
		i = encodeVarintPipeline(dAtA, i, uint64(m.ClusterTerm))
		i--
		dAtA[i] = 0x20
	}
	if m.SyncType != 0 {
...
func (m *Pipeline) Size() (n int) {
	...
	if m.ClusterTerm != 0 {
		n += 1 + sovPipeline(uint64(m.ClusterTerm))
	}
	if m.XXX_unrecognized != nil {
...
func (m *Pipeline) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ClusterTerm", wireType)
			}
			m.ClusterTerm = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ClusterTerm |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
